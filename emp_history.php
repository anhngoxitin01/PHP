        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    ?>
                    <p><b>Tên : </b> <?php echo $employee['emp_name']; ?></p>
                    <p><b>Lương: </b> <?php echo $employee['salary'].'/-'; ?></p>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Mô Tả Nhân Viên</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Mô Tả Nhân Viên:</div>
                                    <div class="panel-body">
