...
if (isset($_POST['add_service'])) {
    ...
    $unit_service = $_POST['unit_service'];
    $time_start = $_POST['time_start'];
    $time_end = $_POST['time_end'];
    $max_custom = $_POST['max_custom'];
    $number_custom = $_POST['number_custom'];

    if ($name_service == '' && $type_service == '' && $price_service == '' && $unit_service == ''){
        $response['done'] = false;
        $response['data'] = "Please Enter Carednalities";
    }else{
        $service_sql = "INSERT INTO service (name_service,type_service,price_service,unit_service,time_start,time_end,max_custom,number_custom) 
			VALUES ('$name_service','$type_service','$price_service','$unit_service','$time_start','$time_end','$max_custom','$number_custom')";
